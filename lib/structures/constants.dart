class ApiConstants {
  ...
  static String baseUrl =
      'https://api.ra1g.eu/api/cardhub'; // change it for production
  //static String baseUrl = 'http://10.0.2.2:80/cardhub_backend/api/cardhub'; // change it for developing 10.0.2.2
  ...
  static String registerWithCode = '/registerNewAccount';
}
